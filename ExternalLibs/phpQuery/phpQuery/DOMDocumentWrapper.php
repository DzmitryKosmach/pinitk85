...
//		phpQuery::$documents[$id] = $this;
		$this->contentType = is_null($contentType) ? "" : strtolower($contentType);
...
//		$this->document->encoding = $charset;
	...
	protected function loadMarkupHTML($markup, $requestedCharset = null) {
		...
		$requestedCharset = is_null($requestedCharset) ? "" : strtoupper($requestedCharset);
		$documentCharset = is_null($documentCharset) ? "" : strtoupper($documentCharset);
