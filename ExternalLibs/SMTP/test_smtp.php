 ...
 */
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	$from="seka19@gmail.com";                           /* Change this to your address like "me@mydomain.com"; */ $sender_line=__LINE__;
	$to="pseed.manager@gmail.com";                             /* Change this to your test recipient address */ $recipient_line=__LINE__;
	...
	$smtp->user="seka19@gmail.com";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="pentium2008seka";                 /* Set to the authetication password */
