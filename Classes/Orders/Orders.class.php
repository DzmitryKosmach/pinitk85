...
class Orders extends ExtDbList
{
  ...
  static $paymethods = array(
    ...
    self::PAYMETHOD_CARD => 'Банковская карта',
  ...
  static $paymethodsComments = array(
    self::PAYMETHOD_NO => '',
    self::PAYMETHOD_CARD => 'МИР, Master Card или Visa',
    self::PAYMETHOD_RASR => 'Cчет/Договор',
    self::PAYMETHOD_CASH => 'Вы сможете оплатить стоимость заказа наличными при получении заказа от курьера. <span class="text-red-500">Только при доставке курьером! Необходимо уточнить у менеджера.</span>',
