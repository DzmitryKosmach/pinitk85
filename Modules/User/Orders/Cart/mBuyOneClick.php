...
class mBuyOneClick
{
    ...
    static function save($initData, $newData)
    {
        ...
        if (self::$output == OUTPUT_FRAME) {
            $_SESSION['flash_msg'] = '<div class="notetext">Ваш заказ успешно отправлен администрации сайта.<br>В ближайшее время с вами свяжется представитель магазин для уточнения деталей</div>';
