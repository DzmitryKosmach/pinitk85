	...
	this.add = function(seriesId, rnd){
		...
		AJAX.lookup(
			...
			function(cnt){
				...
				// new code
				$$$('favorinfo').innerHTML = cnt;
				if (cnt > 0 && $('.compare-items').hasClass('noitems')) {
					$('.compare-items').toggleClass('hide');
					$('.compare-items').removeClass('noitems');
				}
				// new code
			}
		);
	...
	this.remove = function(seriesId, rnd){
		...
		AJAX.lookup(
			...
			function(cnt){
				...
				if (cnt == 0) {
					$('.compare-items').toggleClass('hide');
					$('.compare-items').addClass('noitems');
				};
				// new code
			}
		);
