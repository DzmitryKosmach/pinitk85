...
$(document).ready(function () {
  ...
  $(document).on("click", ".js-minus", function () {
    ...
    // newcode условие для категории, где количество не менее 4
    if ($btn.parent().find(".js-quantity").hasClass("min_4")) {
      if (val > 4) {
        $btn
          .parent()
          .find(".js-quantity")
...
function RSGoPro_OnOfferChangePopup($elementObj) {
  ...
  if (finedOfferID > 0) {
    // image
    if (
      RSGoPro_OFFERS[element_id].OFFERS[finedOfferID].IMAGES[0].src &&
      RSGoPro_OFFERS[element_id].OFFERS[finedOfferID].IMAGES[0].src.indexOf(
        "redsign_devfunc_nophoto"
      ) < 0 &&
...
function RSGoPro_FixPreviewText(element_id) {
  var max_h1 = 350;
  var line_h = 18;
  var h1 = $("#" + RSGOPRO_PopupPrefix + element_id)
    .find(".block.right")
    .outerHeight(true);
  if (h1 != null) {
    if (h1 > max_h1) {
      var $text = $("#" + RSGOPRO_PopupPrefix + element_id)
        .find(".description")
        .find(".text");
      var res =
        Math.floor(($text.outerHeight(true) - (h1 - max_h1)) / line_h) * line_h;
...
function RSGoPro_AddPopup(element_id, $parentsObj) {
  var url =
    SITE_DIR +
    SITE_CATALOG_PATH +
    "/?AJAX_CALL=Y&action=rsgppopup&element_id=" +
    element_id +
    "";
  var html =
    '<div id="' +
    RSGOPRO_PopupPrefix +
    element_id +
    '" class="rsgppopup" style="display:none;">' +
    RSGOPRO_DivsLeft +
  ...
  $.ajax({
    ...
    .done(function (data) {
      $("#" + RSGOPRO_PopupPrefix + element_id)
        .find(".inner")
        .html(data);
      RSGoPro_SetSet();
      RSGoPro_FixPreviewText(element_id);
...
/* search.title-inheader.js  */
function RSGoPro_SearchTitle() {
  if (
    $(".title-search-result").length > 0 &&
    $(".title-search-result").is(":visible")
  ) {
    var trueH = 32,
      needAdd = false;
    $(".title-search-result")
    ...
    if (
      $(".title-search-result").find(".stitle").hasClass("twolines") &&
      !needAdd
    ) {
...
function RSEC_BlockTab() {
  if ($("#rs_easycart").find(".rsec_tabs").find(".rsec_block").length < 1) {
    $("#rs_easycart")
      .find(".rsec_tabs")
      .css({ position: "relative" })
      .append('<div class="rsec_block"><i class="rsec_ikonka"></i></div>');
  }
}
...
function RSEC_SetHeight() {
  ...
  maxHeight =
    $("#rs_easycart").find(".rsec.rsec_headers").offset().top -
    window.pageYOffset -
    50;
  if (savedHeight > 50) {
    if (savedHeight < maxHeight) {
      $("#rs_easycart")
        .find(".rsec_content .rsec_tabs")
        .css({ height: savedHeight + "px" });
    }
  } else {
    $("#rs_easycart")
      .find(".rsec_content .rsec_tabs")
...
function RSEC_COMPARE_Refresh() {
  ...
  $.ajax({
    ...
    .always(function () {
      if (
        $("#rs_easycart").find("#rsec_compare").find(".rsec_jsline").length > 0
      ) {
        $("#rs_easycart")
          .find(".rsec_headers")
          .find(".rsec_changer.rsec_compare")
          .removeClass("rsec_changer_hide");
        $("#rs_easycart")
          .find(".rsec_headers")
          .find(".rsec_changer.rsec_compare")
          .find(".rsec_cnt")
          .html(
            $("#rs_easycart").find("#rsec_compare").find(".rsec_jsline").length
          );
      } else {
        $("#rs_easycart")
          .find(".rsec_headers")
...
function RSEC_FAVORITE_Refresh() {
  ...
  if (
    $("#rs_easycart").find("#rsec_favorite").find("#rsec_indent").length > 0
  ) {
    data =
      data +
      $("#rs_easycart")
        ...
        .attr("name") +
      "=" +
      $("#rs_easycart").find("#rsec_favorite").find("#rsec_indent").val() +
      "&";
  }
  RSEC_BlockTab();
  $.ajax({
    ...
    .always(function () {
      if (
        $("#rs_easycart").find("#rsec_favorite").find(".rsec_jsline").length > 0
      ) {
        $("#rs_easycart")
          .find(".rsec_headers")
          .find(".rsec_changer.rsec_favorite")
          .removeClass("rsec_changer_hide");
        $("#rs_easycart")
          .find(".rsec_headers")
          .find(".rsec_changer.rsec_favorite")
          .find(".rsec_cnt")
          .html(
            $("#rs_easycart").find("#rsec_favorite").find(".rsec_jsline").length
          );
      } else {
        $("#rs_easycart")
          .find(".rsec_headers")
...
function RSEC_BASKET_Refresh() {
  ...
  $.ajax({
    ...
    .done(function (response) {
      ...
      setTimeout(function () {
        if (
          $("#rs_easycart").find("#rsec_basket").find(".rsec_take_normalCount")
            .length > 0
        ) {
          $("#rs_easycart")
            .find(".rsec_normalCount")
            .html(
              $("#rs_easycart")
                .find("#rsec_basket")
                .find(".rsec_take_normalCount")
                .html()
            );
          $("#rs_easycart")
            .find(".rsec_allSum_FORMATED")
            .html(
              $("#rs_easycart")
                .find("#rsec_basket")
...
$(document).ready(function () {
  ...
  $(document).on(
    "click",
    "#rs_easycart .rsec_headers .rsec_changer",
    function () {
      RSEC_SwitchTab($(this));
      return false;
    }
  ...
  $(document).mousemove(function (e) {
    ...
    if (
      RSEC_flag_tension_line &&
      RSEC_ec_start_height + RSEC_ec_start_coordY - e.pageY > 100
    ) {
      $.cookie(
        RSEC_BX_COOKIE_PREFIX + "RSEC_HEIGHT",
        RSEC_ec_start_height + RSEC_ec_start_coordY - e.pageY,
        "/"
      );
      RSEC_SetHeight();
    }
  ...
  $(document)
    .on("mouseenter", "#rs_easycart .rsec_quantity", function () {
      $("html").addClass("rsec_disableSelection");
    })
  ...
  $(document).on(
    "click",
    "#rs_easycart .rsec_thistab_compare .rsec_delall",
    function () {
      $(this)
        .parents("form")
        .find('input[name^="DELETE_"]')
  ...
  $(document).on(
    "click",
    "#rs_easycart .rsec_thistab_compare .rsec_delete",
    function () {
      $(this)
        .parents(".rsec_jsline")
        .find('input[name^="DELETE_"]')
  ...
  $(document).on(
    "click",
    "#rs_easycart .rsec_thistab_compare .rsec_delsome",
    function () {
      RSEC_COMPARE_Refresh();
      return false;
    }
  ...
  $(document).on(
    "click",
    "#rs_easycart .rsec_thistab_favorite .rsec_delall",
    function () {
      $(this)
        .parents("form")
        .find('input[name^="DELETE_"]')
  ...
  $(document).on(
    "click",
    "#rs_easycart .rsec_thistab_favorite .rsec_delete",
    function () {
      $(this)
        .parents(".rsec_jsline")
        .find('input[name^="DELETE_"]')
  ...
  $(document).on(
    "click",
    "#rs_easycart .rsec_thistab_favorite .rsec_delsome",
    function () {
      RSEC_FAVORITE_Refresh();
      return false;
    }
  ...
  $(document).on(
    "click",
    "#rs_easycart .rsec_thistab_basket .rsec_plus, #rs_easycart .rsec_thistab_basket .rsec_minus",
    function () {
  ...
  $(document).on(
    "click",
    "#rs_easycart .rsec_thistab_basket .rsec_delall",
    function () {
      $(this)
        .parents("form")
        .find('input[name^="DELETE_"]')
  ...
  $(document).on(
    "click",
    "#rs_easycart .rsec_thistab_basket .rsec_delete",
    function () {
      $(this)
        .parents(".rsec_jsline")
        .find('input[name^="DELETE_"]')
  ...
  $(document).on(
    "click",
    "#rs_easycart .rsec_thistab_basket .rsec_refresh, #rs_easycart .rsec_thistab_basket .rsec_delsome, #rs_easycart .rsec_thistab_basket .rsec_coup",
    function () {
      RSEC_BASKET_Refresh();
      return false;
    }
  ...
  if ($("#rs_easycart").find(".rsec_universalhandler").length > 0) {
    ...
    // COMPARE
    if (
      $("#rs_easycart").find("#rsec_compare").hasClass("rsec_universalhandler")
    ) {
      ajaxFinderCompare_add = $("#rs_easycart")
        .find("#rsec_compare")
        .data("ajaxfinder_add");
    }
    if (
      ...
      ajaxFinderCompare_remove = $("#rs_easycart")
        .find("#rsec_compare")
        .data("ajaxfinder_remove");
    }

    // FAVORITE
    if (
      $("#rs_easycart").find("#rsec_favorite").hasClass("rsec_universalhandler")
    ) {
      ajaxFinderFavorite = $("#rs_easycart")
        .find("#rsec_favorite")
        .data("ajaxfinder");
    }
    ...
    // BASKET
    if (
      $("#rs_easycart").find("#rsec_basket").hasClass("rsec_universalhandler")
    ) {
      ajaxFinderBasket = $("#rs_easycart")
        .find("#rsec_basket")
        .data("ajaxfinder");
    }

    if (
      ajaxFinderCompare_add != "" ||
      ajaxFinderCompare_remove != "" ||
      ajaxFinderFavorite != "" ||
      ajaxFinderBasket != ""
    ) {
      $(document).ajaxSuccess(function (event, xhr, settings) {
        ...
        if (
          (ajaxFinderCompare_add != "" &&
            settings.url.indexOf(ajaxFinderCompare_add, 0) > 0) ||
          (ajaxFinderCompare_remove != "" &&
            settings.url.indexOf(ajaxFinderCompare_remove, 0) > 0)
        ) {
          RSEC_COMPARE_Refresh();
        }
        // FAVORITE
        if (
          ajaxFinderFavorite != "" &&
          settings.url.indexOf(ajaxFinderFavorite, 0) > 0
        ) {
          RSEC_FAVORITE_Refresh();
        }
        // BASKET
        if (
          ajaxFinderBasket != "" &&
          settings.url.indexOf(ajaxFinderBasket, 0) > 0
        ) {
          RSEC_BASKET_Refresh();
        }
      });
