...
$(document).ready(function(){
  ...
  RSGoPro_FancyOptions1 = {
    ...
    padding			: 20,
    tpl				: {
      closeBtn : '<a title="Close" class="fancybox-item fancybox-close mt-2 mr-2 w-12 h-12 flex items-center justify-center text-5xl text-black-500 z-10 rounded-full hover:bg-red-400 transition-colors" href="javascript:;">×</a>',
    },
    helpers			: {
      title : {
        type : 'inside',
