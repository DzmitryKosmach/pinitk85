...
$(document).ready(function(){
	...
	$(document).on('click','a.changeimage', function(){
		/* neoways */
		if($$$('series-set-points')){
			if(this.dataset['photonum'] == '0'){
				$$$('series-set-points').style.display ='block';
			}else{
				$$$('series-set-points').style.display ='none';
			}
		}
		/* neoways-end */
	...
	if(!RSDevFunc_PHONETABLET) {
		...
		$(document).on('click','.pictures .glass:not(.itempic)', function(){
			$.fancybox.open(
				$('.fancyimages'),
				{
					type			: 'inline',
