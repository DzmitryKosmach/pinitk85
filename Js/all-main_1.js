    ...
    oMaterials.onSave = function (price, material) {
      ...
      if (price.current > 0) {
        ...
        if (price.old) {
          ...
          $$$("item1-" + itemId + "-price-old").innerHTML = priceFormat(
            price.old
          );
        } else {
        ...
        if ($$$("item1-" + itemId + "-price-in")) {
          ...
          $$$("item1-" + itemId + "-price-in").innerHTML = priceFormat(
            price.in
          );
        }
      } else {
    ...
    oMaterials.onSave = function (price, material) {
      ...
      if (price.current) {
        ...
        if (price.old) {
          ...
          $$$("item2-" + itemId + "-price-old").innerHTML = priceFormat(
            price.old
          );
        } else {
        ...
        if ($$$("item2-" + itemId + "-price-in")) {
          $$$("item2-" + itemId + "-price-old").style.display = "";
          $$$("item2-" + itemId + "-price-in").innerHTML = priceFormat(
            price.in
          );
        }
      } else {
