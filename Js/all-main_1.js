    ...
    oPopup.loadUrl("", url, false, function () {
        ...
        oMaterials.onSave = function (price, material) {
            ...
            if (price.current > 0) {
                ...
                $$$("item1-" + itemId + "-price").innerHTML = priceFormat(
                    price.current
                );
                if (price.old) {
                    $$$("item1-" + itemId + "-price-old").style.display = "";
                    $$$("item1-" + itemId + "-price-old").innerHTML =
                ...
                if ($$$("item1-" + itemId + "-price-in")) {
                    ...
                    $$$("item1-" + itemId + "-price-in").innerHTML =
        ...
        oMaterials.open(itemId, $$$("item1-" + itemId + "-material").value);
