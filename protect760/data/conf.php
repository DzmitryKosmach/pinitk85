...
$ab_config['phperror'] = 0;
$ab_config['timezone'] = 'Europe/Moscow';
$ab_config['webdir'] = '/protect760/'; // change if renamed script directory
$ab_config['ab_url'] = '';
$ab_config['cookie'] = 'mvMlUt';
$ab_config['auth'] = 'cookie'; // sqlite or cookie
$ab_config['js_error_msg'] = 'Your request has been denied.';
$ab_config['email'] = 'info@mebelioni.ru'; // change to your email
$ab_config['pass'] = 'UwheMwk7cDLOhPEnOI4SMKEnOI4SMK1111'; // change to your password
$ab_config['secondpass'] = ''; // delete this line if you forgot second password
$ab_config['salt'] = 'LAswtqcbZ_'.date('YW', time());
$ab_config['timesalt'] = 'YW';
...
$ab_config['tpl_lang'] = '';
$ab_config['buttons'] = 0; // buttons type
...
$ab_config['iframe_stop'] = 1; // 1 - block, 0 - no check
$ab_config['last_rule'] = '';
